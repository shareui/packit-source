...
try:
    ...
    _strings = None
    log(f"nativeLoader: import strings failed: {_e}")
    ...
    try:
        ...
        def _show():
            try:
                ...
                desc.setText(str(_strings("native_error_desc", name=libName)) if _strings else f"Unfortunately, an error occurred in the native library {libName} :(")
