...
def _show_plugin_menu(act, p, anchor_view, repo_id: str = ""):
    try:
        from ..plugins.helpers.PluginActions import share_plugin_file, view_plugin_code, download_plugin_file
        from ..plugins.helpers.ReportService import report_plugin
...
class PluginProfileFragment(dynamic_proxy(UniversalFragment.UniversalFragmentDelegate)):
    ...
    def beforeCreateView(self):
        ...
        if has_link:
            from ...utils.AppVersion import check_app_version as _check_app_version
            ...
            def onInstallClickFab(v, _p=p, _install_ui=_install_ui_ref, _all=_all_plugins_ref,
                ...
                if not versions:
                    ...
                    return
                from ...utils.AppVersion import check_app_version as _check_app_version2
