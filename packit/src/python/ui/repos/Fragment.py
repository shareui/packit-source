...
class ReposFragment(dynamic_proxy(UniversalFragment.UniversalFragmentDelegate)):
    ...
    def _summary_text(self, count: int) -> str:
        try:
            from ..plugins.helpers.Utils import _format_plural
    ...
    def _build_summary_row(self, act):
        ...
        from ..plugins.helpers.UiHelpers import get_theme_colors, apply_press_scale_on_target
    ...
    def _build_add_button(self, act):
        ...
        try:
            from ..plugins.helpers.UiHelpers import apply_press_scale
