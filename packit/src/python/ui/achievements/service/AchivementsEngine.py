...
def _load_lib():
    from ....core.NativeLoader import loadPackitDb
    lib = loadPackitDb()
    if lib is not None:
...
_XP_REWARDS = {
    ...
    "secret_aytist": 5800,
    "secret_connect_is_bullshit": 5000,
    "secret_opsec": 1337,
}
...
_SECRET_ACHIEVEMENTS = {"secret_premium", "secret_terraria", "secret_identity", "secret_curiosity", "secret_subscriber", "secret_enlightened", "secret_talking_about_you", "secret_utils_rule", "secret_aytist", "secret_connect_is_bullshit", "secret_opsec"}
...
def _show_achievement_bulletin(achievement: dict, on_hide=None):
    try:
        ...
        def show():
            ...
            def _open():
                from ..Fragment import show_hint_sheet
