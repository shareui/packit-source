...
from ..dialogs.FontPickerBottomSheet import showFontPicker
from ..components.FontManager import getSelectedFilename
...
class OtherSettings:
    ...
    def _onClearIgnoreListClick(self, view):
        try:
            from ..updates.ClearIgnoreListDialog import show_clear_ignore_list_dialog
            frag = get_last_fragment()
            act = frag.getParentActivity() if frag else None
            if not act:
                return
